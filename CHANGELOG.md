...
- bd8b416: Add documentation for CLI options splitting syntax variants
...
- 56b3925: Add code coverage support with threshold enforcement for all runtimes (Bun, Deno, Node.js)
...
- 6255b9f: Fix release formatting script to handle Major/Minor/Patch changes
